...
module PaypalServerSdk
  ...
  class Plan < BaseModel
    ...
    def initialize(billing_cycles:, one_time_charges:, name: SKIP)
    ...
    def to_s
      ...
      "<#{class_name} billing_cycles: #{@billing_cycles}, one_time_charges: #{@one_time_charges},"\
      " name: #{@name}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} billing_cycles: #{@billing_cycles.inspect}, one_time_charges:"\
      " #{@one_time_charges.inspect}, name: #{@name.inspect}>"
    end
  end
end

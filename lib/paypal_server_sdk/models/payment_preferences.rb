...
module PaypalServerSdk
  ...
  class PaymentPreferences < BaseModel
    ...
    def initialize(auto_bill_outstanding: true, setup_fee: SKIP,
    ...
    def self.from_hash(hash)
      ...
      auto_bill_outstanding = hash['auto_bill_outstanding'] ||= true
      setup_fee = Money.from_hash(hash['setup_fee']) if hash['setup_fee']
      setup_fee_failure_action =
        hash['setup_fee_failure_action'] ||= SetupFeeFailureAction::CANCEL
      payment_failure_threshold = hash['payment_failure_threshold'] ||= 0

      # Create object from extracted values.
      PaymentPreferences.new(auto_bill_outstanding: auto_bill_outstanding,
                             setup_fee: setup_fee,

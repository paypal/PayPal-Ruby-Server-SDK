...
module PaypalServerSdk
  ...
  class SubscriptionCardRequest < BaseModel
    SKIP = Object.new
    ...
    # @return [SubscriptionsCardAttributes]
    ...
    def self.from_hash(hash)
      ...
      attributes = SubscriptionsCardAttributes.from_hash(hash['attributes']) if hash['attributes']

      # Create object from extracted values.
      SubscriptionCardRequest.new(name: name,
                                  number: number,
                                  expiry: expiry,
    ...
    def inspect
      ...
      " brand: #{@brand.inspect}, billing_address: #{@billing_address.inspect}, attributes:"\
      " #{@attributes.inspect}>"
    end
  end
end

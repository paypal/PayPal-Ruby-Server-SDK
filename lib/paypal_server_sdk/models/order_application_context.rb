...
module PaypalServerSdk
  ...
  class OrderApplicationContext < BaseModel
    ...
    # referred to as stored_credential or card-on-file). Parameter
    # compatibility: `payment_type=ONE_TIME` is compatible only with

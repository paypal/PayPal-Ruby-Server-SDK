...
module PaypalServerSdk
  ...
  class SubscriptionsCardAttributes < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      customer = CardCustomer.from_hash(hash['customer']) if hash['customer']
      ...
      SubscriptionsCardAttributes.new(customer: customer,
                                      vault: vault,

...
module PaypalServerSdk
  ...
  class VaultCardExperienceContext < BaseModel
    SKIP = Object.new
    ...
    def initialize(brand_name: SKIP, locale: SKIP, return_url: SKIP,
                   cancel_url: SKIP, vault_instruction: SKIP,
    ...
    def self.from_hash(hash)
      ...
      VaultCardExperienceContext.new(brand_name: brand_name,
                                     locale: locale,
    ...
    def to_s
      ...
      " cancel_url: #{@cancel_url}, vault_instruction: #{@vault_instruction}, user_action:"\
      " #{@user_action}>"
    end
    ...
    def inspect
      ...
      " #{@vault_instruction.inspect}, user_action: #{@user_action.inspect}>"
    end
  end
end

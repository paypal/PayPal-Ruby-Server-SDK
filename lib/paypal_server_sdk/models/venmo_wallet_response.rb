...
module PaypalServerSdk
  ...
  class VenmoWalletResponse < BaseModel
    ...
    def initialize(email_address: SKIP, account_id: SKIP, user_name: SKIP,
                   ...
                   return_flow: ReturnFlow::AUTO, attributes: SKIP)
    ...
    def self.from_hash(hash)
      ...
      return_flow = hash['return_flow'] ||= ReturnFlow::AUTO
    ...
    def to_s
      ...
      " return_flow: #{@return_flow}, attributes: #{@attributes}>"
    end
    ...
    def inspect
      ...
      " phone_number: #{@phone_number.inspect}, address: #{@address.inspect}, return_flow:"\
      " #{@return_flow.inspect}, attributes: #{@attributes.inspect}>"
    end
  end
end

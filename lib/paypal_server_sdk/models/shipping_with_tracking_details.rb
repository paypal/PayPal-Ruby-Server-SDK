...
module PaypalServerSdk
  # ShippingWithTrackingDetails Model.
  class ShippingWithTrackingDetails < BaseModel
    ...
    # @return [PhoneNumberWithOptionalCountryCode]
    ...
    def initialize(trackers: SKIP, name: SKIP, email_address: SKIP,
                   phone_number: SKIP, type: SKIP, options: SKIP, address: SKIP)
    ...
    def self.from_hash(hash)
      ...
      phone_number = PhoneNumberWithOptionalCountryCode.from_hash(hash['phone_number']) if
        hash['phone_number']
      ...
      ShippingWithTrackingDetails.new(trackers: trackers,
                                      name: name,
    ...
    def to_s
      ...
      "<#{class_name} trackers: #{@trackers}, name: #{@name}, email_address: #{@email_address},"\
      " phone_number: #{@phone_number}, type: #{@type}, options: #{@options}, address:"\
      " #{@address}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} trackers: #{@trackers.inspect}, name: #{@name.inspect}, email_address:"\
      " #{@email_address.inspect}, phone_number: #{@phone_number.inspect}, type: #{@type.inspect},"\
      " options: #{@options.inspect}, address: #{@address.inspect}>"
    end
  end
end

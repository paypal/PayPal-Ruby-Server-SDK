...
| `dispute_categories` | [`Array[DisputeCategory]`](../../doc/models/dispute-category.md) | Optional, Read-only | An array of conditions that are covered for the transaction. |

## Example

```ruby
seller_protection = SellerProtection.new
```

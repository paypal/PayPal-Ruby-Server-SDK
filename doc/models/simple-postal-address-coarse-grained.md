...
|  --- | --- | --- | --- |
| `line_1` | `String` | Required | The first line of the address. For example, number or street. |
| `line_2` | `String` | Optional | The second line of the address. For example, suite or apartment number. |
...
```ruby
simple_postal_address_coarse_grained = SimplePostalAddressCoarseGrained.new(
  line1: 'line12',
  city: 'city0',

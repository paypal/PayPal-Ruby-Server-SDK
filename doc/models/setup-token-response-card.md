...
| `last_digits` | `String` | Optional, Read-only | The last digits of the payment card.<br><br>**Constraints**: *Minimum Length*: `2`, *Maximum Length*: `4`, *Pattern*: `[0-9]{2,}` |
...
```ruby
setup_token_response_card = SetupTokenResponseCard.new(
  name: 'name8',

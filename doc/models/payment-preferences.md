...
|  --- | --- | --- | --- |
| `auto_bill_outstanding` | `TrueClass \| FalseClass` | Optional | Indicates whether to automatically bill the outstanding amount in the next billing cycle.<br><br>**Default**: `true` |

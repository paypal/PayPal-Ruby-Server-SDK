...
| `links` | [`Array[LinkDescription]`](../../doc/models/link-description.md) | Optional, Read-only | An array of request-related HATEOAS links. |
...
```ruby
order_tracker_response = OrderTrackerResponse.new(

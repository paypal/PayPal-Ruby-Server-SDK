...
| `business_name` | `String` | Optional | The business name of the PayPal account holder (populated for business accounts only)<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `300`, *Pattern*: `^.*$` |

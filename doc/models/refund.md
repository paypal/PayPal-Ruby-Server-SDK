...
| `note_to_payer` | `String` | Optional, Read-only | The reason for the refund. Appears in both the payer's transaction history and the emails that the payer receives. |

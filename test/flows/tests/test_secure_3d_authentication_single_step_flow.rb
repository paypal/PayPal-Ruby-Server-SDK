...
class Secure3DAuthenticationSingleStepFlowTest < FlowTestBase
  ...
  def test_secure_3d_authentication_single_step
    ...
    current_path = @ui_flow_executor.complete_helios_verification(url: order_api_response.data.links.at(1).href)
